...
const Blog = ({blog}) => {
    ...
    return (
        <Link to = '' className="max-w-sm mx-auto group hover:no-underline focus:no-underline border-2 bg-white shadow-xl p-4 rounded-lg hover:scale-105 hover:border-teal-900 transition-all duration-300 ease-in-out">
